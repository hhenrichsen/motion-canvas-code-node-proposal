import {patienceDiff} from '@components/diff';
import {CodeScope, CodeTag, resolveScope} from '@components/CodeScope';
import {CodeTokenizer} from '@components/CodeTokenizer';
...
/**
 * Default diffing function utilizing {@link patienceDiff}.
 *
